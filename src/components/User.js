...
const User = (props) => {
    ...
    */
    ...
    return !user
        ...
        ? <div className="user-page"><h1>LOADING...</h1></div>
        : (
            <div className="user-page">
                ...
                <Switch>
                    <Route path={`${props.match.path}/followers`} component={() => <Followers user={user} />} />
                    <Route path={`${props.match.path}/following`} component={() => <Following user={user} />} />
                    <Route path={`${props.match.path}/repos`} component={() => <Repos user={user} />} />
                </Switch>
            </div>
        );
}
